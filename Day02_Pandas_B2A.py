...
print("\n David: \n", df.loc[df['Name'] == 'David'])  # Accessing a single column

print("\n Age > 25: \n", df[df['Age'] > 25])  # Accessing rows based on a condition

print("\n Names contains 'a': \n", df[df['Name'].str.contains('a')])  # Accessing rows based on string condition
